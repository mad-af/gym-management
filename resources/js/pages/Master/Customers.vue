...
const tableData = computed(() => {
    return customers.value.map((c: any) => {
        return {
            ...
            is_expiring_soon: c.is_expiring_soon ?? false,
        };
    });
});
...
const columns = ref<Column[]>([
    ...
    },
    {
        key: 'active_package',
        label: 'Paket Aktif',
        class: 'min-w-[140px] max-w-[200px] break-words',
    },
