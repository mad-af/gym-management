                    ...
                    <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Masukkan kata sandi baru Anda untuk mengatur ulang kata sandi akun Anda.
                            </p>
                        </div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" v-model="form.email" name="email"
                                            ...
                                            class="dark:bg-dark-900 font-noraml h-11 w-full rounded-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-left text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-800 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 cursor-not-allowed" />
                                        <div v-if="form.errors.email" class="mt-1.5 text-sm text-error-500">
                                            {{ form.errors.email }}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" id="password"
                                                v-model="form.password" name="password" placeholder="Masukkan kata sandi baru"
                                        ...
                                        <div v-if="form.errors.password" class="mt-1.5 text-sm text-error-500">
                                    ...
                                    <div>
                                        <button :disabled="form.processing"
                                            ...
                                            <span v-if="form.processing">Sedang Mengatur Ulang...</span>
