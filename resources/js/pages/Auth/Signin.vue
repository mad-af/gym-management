                                    ...
                                    <div class="space-y-5">
                                                ...
                                                <label for="keepLoggedIn"
                                                    ...
                                                    <div class="relative">
                                                        <input v-model="form.remember
                                                            " type="checkbox" id="keepLoggedIn" class="sr-only" />
                                        ...
                                        <div>
                                            <button type="submit" :disabled="form.processing"
                                                class="flex w-full items-center justify-center rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs transition hover:bg-brand-600 disabled:opacity-50 disabled:cursor-not-allowed">
