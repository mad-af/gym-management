                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-y border-gray-200 dark:border-gray-700">
                            <th scope="col"
                                class="px-4 py-3 text-start text-theme-sm font-normal text-gray-500 dark:text-gray-400">
                                Name
                            </th>
                            <th scope="col"
                                class="px-4 py-3 text-start text-theme-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <th scope="col"
                                class="px-4 py-3 text-left text-xs font-medium tracking-wider text-gray-500 capitalize">
                                Category
                            </th>
                            <th scope="col"
                                class="px-4 py-3 text-start text-theme-sm font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <td class="py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="h-8 w-8 shrink-0">
                                        <img class="h-8 w-8 rounded-full" :src="transaction.image" alt="" />
                                    </div>
                                    <div class="ml-4">
        ...
        <div class="border-t border-gray-200 px-6 py-4 dark:border-white/[0.05]">
            <div class="flex items-center justify-between">
                <button @click="prevPage" :disabled="currentPage === 1"
                    class="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-3 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 sm:px-3.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
