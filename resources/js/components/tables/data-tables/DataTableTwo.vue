<template>
    <div class="overflow-hidden">
        <div
            class="flex flex-col gap-2 rounded-xl rounded-b-none border border-b-0 border-gray-100 px-4 py-4 sm:flex-row sm:items-center sm:justify-between dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="max-w-full overflow-x-auto">
            <table class="min-w-full">
                <thead>
                    <tr>
                        <th v-for="(column, index) in columns" :key="index" :class="column.class" class="text-left">
                        ...
                        <th class="border border-gray-100 px-4 py-3 text-left dark:border-white/[0.05]">
                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">
                                Action
                            </p>
                        </th>
                ...
                <tbody>
                    <tr v-for="person in paginatedData" :key="person.id"
                        ...
                        <td class="border border-gray-100 px-4 py-[17.5px] dark:border-white/[0.05]">
        ...
        <!-- Pagination Controls -->
        <div class="rounded-b-xl border border-t-0 border-gray-100 py-4 pr-4 pl-[18px] dark:border-white/[0.05]">
