<template>
    <div class="overflow-hidden">
        <div
            class="flex flex-col gap-2 rounded-xl rounded-b-none border border-b-0 border-gray-200 px-4 py-4 sm:flex-row sm:items-center sm:justify-between dark:border-gray-800">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <button
                    class="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-[11px] text-sm font-medium text-gray-700 shadow-theme-xs sm:w-auto dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">
                    Download
                    <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="max-w-full overflow-x-auto">
            <table class="w-full min-w-full">
                <thead>
                    <tr>
                        <th class="border border-gray-100 px-4 py-3 text-left dark:border-gray-800">
                ...
                <tbody>
                    <tr v-for="person in paginatedData" :key="person.id" class="" :class="{
                        'bg-gray-50 dark:bg-gray-900': person.selected,
                    }">
                            ...
                            <div class="flex gap-3">
                                <div class="mt-1">
                                    <label
                                        class="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                        <span class="relative">
                                            <input type="checkbox" class="sr-only" v-model="person.selected"
                                                @change="updateSelectAll" />
                                            <span :class="person.selected
                                                    ? 'border-brand-500 bg-brand-500'
                                                    : 'border-gray-300 bg-transparent dark:border-gray-700'
                                                "
                                                class="flex h-4 w-4 items-center justify-center rounded-sm border-[1.25px]">
