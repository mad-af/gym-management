<template>
    <div class="overflow-hidden rounded-xl bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div
            class="flex flex-col gap-2 rounded-t-xl border border-b-0 border-gray-100 px-4 py-4 sm:flex-row sm:items-center sm:justify-between dark:border-white/[0.05]">
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="border-t border-gray-100 dark:border-white/[0.05]">
                        <th v-for="column in columns" :key="column.key"
                            class="border border-gray-100 px-4 py-3 dark:border-white/[0.05]">
                ...
                <tbody>
                    <tr v-for="person in paginatedData" :key="person.id" class="">
                        <td class="border border-gray-100 px-4 py-3 dark:border-white/[0.05]">
                            <div class="flex items-center gap-3">
