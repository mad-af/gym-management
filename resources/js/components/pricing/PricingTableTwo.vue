<template>
    <div class="gird-cols-1 grid gap-5 sm:grid-cols-2 xl:grid-cols-3 xl:gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 xl:p-8 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <ul class="mb-8 space-y-3">
                <li v-for="(item, index) in personalPack" :key="index" :class="[
                    'flex items-center gap-3 text-sm',
                    item.included
                        ? 'text-gray-700 dark:text-gray-400'
                        : 'text-gray-400',
                ]">
                    <svg v-if="item.included" class="text-success-500" width="16" height="16" viewBox="0 0 16 16"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.4017 4.35986L6.12166 11.6399L2.59833 8.11657" stroke="currentColor"
                            stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <svg v-else class="text-gray-400" width="17" height="16" viewBox="0 0 17 16" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div
            class="rounded-2xl border-2 border-brand-500 bg-white p-6 xl:p-8 dark:border-brand-500 dark:bg-white/[0.03]">
            <div class="-mb-4 flex items-start justify-between">
                <span class="block text-theme-xl font-semibold text-gray-800 dark:text-white/90">
                    Professional
                </span>
            ...
            <ul class="mb-8 space-y-3">
                <li v-for="(item, index) in professionalPack" :key="index" :class="[
                    'flex items-center gap-3 text-sm',
                    item.included
                        ? 'text-gray-700 dark:text-gray-400'
                        : 'text-gray-400',
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 xl:p-8 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <ul class="mb-8 space-y-3">
                <li v-for="(item, index) in enterprisePack" :key="index" :class="[
                    'flex items-center gap-3 text-sm',
                    item.included
                        ? 'text-gray-700 dark:text-gray-400'
                        : 'text-gray-400',
