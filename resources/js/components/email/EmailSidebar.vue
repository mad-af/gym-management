<template>
    <div
        ...
        <Simplebar class="max-h-[550px] 2xl:max-h-[640px]">
            <div class="no-scrollbar overflow-auto py-6">
                <nav class="space-y-5">
                    <!-- Mailbox Group -->
                    <div>
                        <h3 class="mb-3 text-xs leading-[18px] font-medium text-gray-700 uppercase dark:text-gray-400">
                            MAILBOX
                        </h3>
                                ...
                                <a :href="item.href"
                                    ...
                                    <span v-if="item.count" :class="{
                                        'text-brand-500 dark:text-brand-400':
                                            isActive === item.name,
                                        'text-gray-700 group-hover:text-brand-500 dark:text-gray-300 dark:group-hover:text-brand-400':
                                            isActive !== item.name,
                                    }">
                                        {{ item.count }}
                                    </span>
