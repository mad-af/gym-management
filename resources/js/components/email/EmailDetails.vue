<template>
    <div class="o sm:h-[calc(100vh-174px)] xl:h-[calc(100vh-186px)]">
        <div class="flex h-full flex-col gap-6 sm:gap-5 xl:grid xl:grid-cols-12">
            ...
            <!-- Inbox Mailbox Start -->
            <div class="w-full xl:col-span-9">
                <div
                    class="flex flex-col rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div
                        class="flex flex-col justify-between border-b border-gray-200 sm:flex-row dark:border-gray-800">
                        <div class="flex w-full items-center justify-between gap-3 px-4 py-4 sm:justify-normal">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex">
                                    <button
                                        class="flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-gray-200 ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 hover:text-error-700 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05] dark:hover:text-error-500">
                                    ...
                                    <button
                                        class="-ml-px flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-gray-200 ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05] dark:hover:text-white">
                                        <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <button
                                        class="-ml-px flex h-10 w-10 items-center justify-center rounded-r-lg text-gray-500 ring-1 ring-gray-200 ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05] dark:hover:text-white">
                                        <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div
                            class="flex w-full items-center justify-between gap-4 border-t border-gray-200 px-4 py-3 sm:justify-end sm:border-t-0 sm:py-5 dark:border-gray-800">
                    ...
                    <Simplebar class="max-h-[500px] 2xl:max-h-[790px]" data-simplebar-auto-hide="false">
                        <div class="block custom-scrollbar overflow-auto p-5 xl:p-6">
                            ...
                            <div class="mb-7 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <p class="mb-4">
                                    ...
                                    adipiscing elit. Praesent ut rutrum mi.
                                    Aenean ac leo non justo suscipit
                                    consectetur. Nam vestibulum eleifend magna
                                    quis porta. ipsum dolor sit amet,
                                    consectetur adipiscing elit. Praesent ut
                                    rutrum mi. Aenean ac leo
                                </p>

                                <p class="mb-4">
                                    Praesent ut rutrum mi. Aenean ac leo non
                                    justo suscipit consectetur. Nam vestibulum
                                    eleifend magna quis porta.
                                </p>

                                <p class="mb-4">
                                    Nullam tincidunt sodales diam, quis rhoncus
                                    dolor aliquet a. Nulla a rhoncus lectus. In
                                    nunc neque, pellentesque non massa ornare,
                                    accumsan ornare massa. odales diam, quis
                                    rhoncus dolor aliquet a. Nulla a rhoncus
                                    lectus. In nunc neque
                                </p>

                                <p class="mb-4">
                                    Suspendisse semper vel turpis vitae aliquam.
                                    Aenean semper dui in consequat ullamcorper.
                                </p>
                                ...
                                <p class="mb-4">
                                    ...
                                    dolor aliquet a. Nulla a rhoncus lectus. In
                                    nunc neque, pellentesque non massa ornare,
                                    accumsan ornare massa. sodales diam, quis
                                    rhoncus dolor aliquet a. Nulla a rhoncus
                                    lectus. In nunc neque
                                </p>
                            ...
                            <div class="rounded-xl bg-gray-50 p-3 sm:p-4 dark:bg-gray-900">
                                ...
                                <div class="flex flex-col items-center gap-3 sm:flex-row">
                                    <div
                                        class="relative flex w-full cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 pr-5 pl-3 sm:w-auto dark:border-gray-800 dark:bg-white/5">
                    ...
                    <div
                        class="sticky bottom-0 rounded-b-2xl border-t border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-[#171f2f]">
                        <div class="flex items-center gap-3">
                            <button
