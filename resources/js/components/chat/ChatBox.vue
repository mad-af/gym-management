<template>
    <div
        class="flex h-full flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white xl:w-3/4 dark:border-gray-800 dark:bg-white/[0.03]">
        <!-- ====== Chat Box Start -->
        <div
            class="sticky flex items-center justify-between border-b border-gray-200 px-5 py-4 xl:px-6 dark:border-gray-800">
            <div class="flex items-center gap-3">
                <div class="relative h-12 w-full max-w-[48px] rounded-full">
                    ...
                    <span
                        class="absolute right-0 bottom-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
                </div>
        ...
        <div class="custom-scrollbar max-h-full flex-1 space-y-6 overflow-auto p-5 xl:space-y-8 xl:p-6">
                    ...
                    <div>
                        <div class="rounded-lg rounded-tl-sm bg-gray-100 px-3 py-2 dark:bg-white/5">
                            <p class="text-sm text-gray-800 dark:text-white/90">
                                I want to make an appointment tomorrow from 2:00
                                to 5:00pm?
                            </p>
                        </div>
            ...
            <div class="ml-auto max-w-[350px] text-right">
                ...
                <div class="mt-2 ml-auto max-w-max rounded-lg rounded-tr-sm bg-brand-500 px-3 py-2 dark:bg-brand-500">
                    <p class="text-sm text-white dark:text-white/90">
        ...
        <div class="sticky bottom-0 border-t border-gray-200 p-3 dark:border-gray-800">
            <form class="flex items-center justify-between">
                <div class="relative w-full">
                    <button
                        class="absolute top-1/2 left-1 -translate-y-1/2 text-gray-500 hover:text-gray-800 sm:left-3 dark:text-gray-400 dark:hover:text-white/90">
                        <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <input type="text" placeholder="Type a message"
                        class="h-9 w-full border-none bg-transparent pr-5 pl-12 text-sm text-gray-800 outline-hidden placeholder:text-gray-400 focus:border-0 focus:ring-0 dark:text-white/90" />
                </div>
