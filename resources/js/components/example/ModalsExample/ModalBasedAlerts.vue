                ...
                <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 lg:p-10 dark:bg-gray-900">
                    <div class="text-center">
                        <div class="relative z-1 mb-7 flex items-center justify-center">
                            <svg class="fill-success-50 dark:fill-success-500/15" width="90" height="90"
                            ...
                            <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                <svg class="fill-success-600 dark:fill-success-500" width="38" height="38"
                        ...
                        <h4 class="mb-2 text-2xl font-semibold text-gray-800 sm:text-title-sm dark:text-white/90">
                            Well Done!
                        </h4>
                        <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">
                            Lorem ipsum dolor sit amet consectetur. Feugiat
                            ipsum libero tempor felis risus nisi non. Quisque eu
                            ut tempor curabitur.
                        </p>

                        <div class="mt-7 flex w-full items-center justify-center gap-3">
                            <button @click="closeSuccessModal" type="button"
                                class="flex w-full justify-center rounded-lg bg-success-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-success-600 sm:w-auto">
                                Okay, Got It
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-7 flex w-full items-center justify-center gap-3">
                            <button @click="closeInfoModal" type="button"
                                class="flex w-full justify-center rounded-lg bg-blue-light-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-blue-light-600 sm:w-auto">
                                Okay, Got It
                            </button>
                        </div>
                    </div>
            ...
            <template #body>
                <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 lg:p-10 dark:bg-gray-900">
                    <div class="text-center">
                        ...
                        <div class="mt-7 flex w-full items-center justify-center gap-3">
                            <button @click="closeWarningModal" type="button"
                                class="flex w-full justify-center rounded-lg bg-warning-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-warning-600 sm:w-auto">
                                Okay, Got It
                            </button>
                        </div>
                    </div>
            ...
            <template #body>
                <div class="relative w-full max-w-[600px] rounded-3xl bg-white p-6 lg:p-10 dark:bg-gray-900">
                    <div class="text-center">
                        ...
                        <div class="mt-7 flex w-full items-center justify-center gap-3">
                            <button @click="closeDangerModal" type="button"
                                class="flex w-full justify-center rounded-lg bg-error-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-error-600 sm:w-auto">
                                Okay, Got It
                            </button>
                        </div>
                    </div>
