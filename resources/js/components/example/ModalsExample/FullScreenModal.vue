<template>
    <ComponentCard title="Full Screen Modal">
        ...
        <Modal v-if="isRegularModalOpen" :fullScreenBackdrop="false" @close="closeRegularModal">
            <template #body>
                <div x-show="isModalOpen"
                    class="fixed top-0 left-0 z-99999 flex h-screen w-full flex-col items-center justify-between overflow-x-hidden overflow-y-auto bg-white p-6 lg:p-10 dark:bg-gray-900">
                    <!-- close btn -->
