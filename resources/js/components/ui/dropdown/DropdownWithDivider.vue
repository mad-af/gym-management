<template>
  <div class="relative inline-block" ref="dropdownRef">
    <a href="#" @click.prevent="toggleDropdown"
      ...
      Options
      <svg class="duration-200 ease-in-out stroke-current" :class="{ 'rotate-180': isOpen }" width="20" height="20"
        viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.79199 7.396L10.0003 12.6043L15.2087 7.396" stroke="currentColor" stroke-width="1.5"
      ...
      <div v-if="isOpen"
        ...
        <ul class="flex flex-col gap-1">
          <template v-for="(item, index) in menuItems" :key="index">
            ...
            <li v-else>
              <a :href="item.href" @click="handleItemClick(item)"
...
const handleItemClick = (item: { text?: string }) => {
  ...
  if (item.text) console.log(`Clicked: ${item.text}`)
  closeDropdown()
}
