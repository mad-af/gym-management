<template>
    <div
        class="rounded-2xl border border-gray-200 bg-white px-5 pt-5 pb-5 sm:px-6 sm:pt-5 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="custom-scrollbar max-w-full overflow-x-auto">
            <div class="-ml-4 min-w-[900px] pl-2 xl:min-w-full">
                <VueApexCharts type="area" height="335" :options="chartOptions" :series="series"></VueApexCharts>
            </div>
        </div>
    </div>
</template>
