<template>
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="w-full overflow-x-auto px-5 sm:px-6">
            <table class="min-w-full">
                <!-- Table Header -->
                <thead>
                    <tr class="border-y border-gray-100 dark:border-gray-800">
                        <th v-for="header in tableHeaders" class="py-3 text-left font-normal" :key="header">
        ...
        <div class="border-t border-gray-200 px-6 py-4 dark:border-gray-800">
            <div class="flex items-center justify-between">
                <button @click="prevPage" :disabled="currentPage === 1"
                    class="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-2 py-2 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 sm:px-3.5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
...
const displayedPages = computed(() => {
    ...
    const rangeStart = Math.max(
        1,
        currentPage.value - Math.floor(rangeSize / 2),
    );
