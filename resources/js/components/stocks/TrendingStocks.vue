            ...
            <div class="stocks-slider-outer relative flex items-center gap-1.5">
                <div class="swiper-button-prev">
                    <svg class="stroke-current" width="16" height="16" viewBox="0 0 16 16" fill="none"
                        ...
                        <path d="M10.1667 4L6 8.16667L10.1667 12.3333" stroke="" stroke-width="1.5"
                ...
                <div class="swiper-button-next">
                    <svg class="stroke-current" width="16" height="16" viewBox="0 0 16 16" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.83333 12.6667L10 8.50002L5.83333 4.33335" stroke="" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
            </div>
            ...
            <SwiperSlide v-for="stock in stocks" :key="stock.symbol">
                <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                    <div
                        ...
                        <div>
                            <div>
                                <h4 class="mb-1 text-right text-theme-sm font-medium text-gray-700 dark:text-gray-400">
                                    {{ stock.price }}
                                </h4>
                            </div>

                            <span class="flex items-center justify-end gap-1 text-theme-xs font-medium" :class="stock.change >= 0
                                    ? 'text-success-600 dark:text-success-500'
                                    : 'text-error-600 dark:text-error-500'
                                ">
                                <svg v-if="stock.change >= 0" class="fill-current" width="12" height="12"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button
                            class="flex w-full items-center justify-center rounded-lg bg-brand-500 p-3 text-theme-sm font-medium text-white shadow-theme-xs hover:bg-brand-600"
