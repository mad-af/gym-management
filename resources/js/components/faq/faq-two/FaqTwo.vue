<template>
    <div class="grid grid-cols-1 gap-x-8 xl:grid-cols-2">
        <div class="space-y-3">
            <FaqItem v-for="(item, index) in faqItems.slice(0, 3)" :key="index" :question="item.question"
                :answer="item.answer" :initialOpen="index === 0" />
        </div>
        <div class="space-y-3">
            <FaqItem v-for="(item, index) in faqItems.slice(3)" :key="index + 3" :question="item.question"
                :answer="item.answer" />
        </div>
    </div>
</template>
