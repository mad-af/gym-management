<template>
    <div>
        <div class="overflow-hidden rounded-xl" :class="isOpen
                ? 'bg-brand-50 dark:bg-brand-100'
                : 'bg-gray-100 dark:bg-white/[0.03]'
            ">
            <div @click="toggleOpen" class="flex cursor-pointer items-center justify-between px-6 py-4">
                <h4 :class="isOpen
                        ? 'text-gray-800'
            ...
            <div v-show="isOpen" class="border-t border-brand-100 p-6 dark:border-brand-200">
