<template>
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-4 py-4 sm:pr-4 sm:pl-6">
        ...
        <div class="border-t border-gray-100 p-4 sm:p-6 dark:border-gray-800">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3">
                <!-- Media item-->
                <div
                    class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pr-4 pl-4 xl:pr-5 dark:border-gray-800 dark:bg-white/[0.03]">
