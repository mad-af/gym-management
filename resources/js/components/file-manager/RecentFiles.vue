            ...
            <table class="w-full table-auto border-collapse">
                ...
                <thead>
                    <tr class="border-t border-gray-200 dark:border-gray-800">
                        <th v-for="header in tableHeaders" :key="header"
                            class="px-6 py-3 text-left text-theme-sm font-medium text-gray-500 dark:text-gray-400">
                            {{ header }}
                        </th>
                        <th class="px-6 py-3 text-center text-theme-sm font-medium text-gray-500 dark:text-gray-400">
                            Action
                        </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr v-for="(row, index) in tableData" :key="index"
                        ...
                        <td class="px-6 py-[18px] text-theme-sm text-gray-700 dark:text-gray-400">
                            {{ row.category }}
                        </td>
                        <td class="px-6 py-[18px] text-theme-sm text-gray-700 dark:text-gray-400">
                            {{ row.size }}
