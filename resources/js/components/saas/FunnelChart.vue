<template>
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="custom-scrollbar overflow-x-auto pl-2">
            <VueApexCharts class="-ml-5 min-w-[700px] xl:min-w-full" :options="chartOptions" :series="series" type="bar"
                height="315"></VueApexCharts>
        </div>
    </div>
</template>
