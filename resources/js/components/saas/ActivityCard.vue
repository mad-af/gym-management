<template>
    ...
    >
        ...
        <div class="relative">
            <!-- Timeline line -->
            <div
                class="absolute top-6 bottom-10 left-5 w-px bg-gray-200 dark:bg-gray-800"
            ></div>
            ...
            <div class="relative mb-6 flex">
                ...
                <div class="ml-4">
                    <div class="mb-1 flex items-center gap-1">
                        ...
                        <p class="text-theme-xs font-medium text-success-500">
                            New invoice
                        </p>
                    </div>
                    <div class="flex items-baseline">
                        ...
                        <span
                            class="ml-2 text-theme-sm font-normal text-gray-500 dark:text-gray-400"
                            >created invoice</span
                        >
                    </div>
                    <p
                        class="text-theme-sm font-normal text-gray-500 dark:text-gray-400"
                    >
                        PQ-4491C
                    </p>
                    <p class="mt-1 text-theme-xs text-gray-400">Just Now</p>
                </div>
            </div>
            ...
            <div class="relative mb-6 flex">
                ...
                <div class="ml-4">
                    <div class="flex items-baseline">
                        ...
                        <span
                            class="ml-2 text-theme-sm text-gray-500 dark:text-gray-400"
                            >created invoice</span
                        >
                    </div>
                    <p
            ...
            <div class="relative flex">
                ...
                <div class="ml-4">
                    ...
                    <p class="mt-1 text-theme-xs text-gray-400">2 weeks ago</p>
                </div>
            </div>
        </div>
    </div>
