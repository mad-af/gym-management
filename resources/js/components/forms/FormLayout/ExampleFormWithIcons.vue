        ...
        <div class="-mx-2.5 flex flex-wrap gap-y-5">
            <div class="w-full px-2.5">
                <div class="relative">
                    ...
                    <input
                        ...
                        class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-3 pl-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                    />
                </div>
            </div>
            ...
            <div class="w-full px-2.5">
                ...
                >
                    <div>
                        ...
                        >
                            <div class="relative">
                                ...
                                >
                                    <span :class="{ 'opacity-0': !rememberMe }">
                                        <svg
                                            width="14"
                                            height="14"
                                            viewBox="0 0 14 14"
                    ...
                    <button
                        type="submit"
                        class="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white hover:bg-brand-600 xl:w-auto"
                    >
                        Create Account
