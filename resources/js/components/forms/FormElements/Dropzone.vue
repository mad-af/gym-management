<template>
    <div class="file-uploader">
        <form ref="dropzoneForm" :id="dropzoneId" :action="uploadUrl"
            class="dropzone rounded-xl border-dashed border-gray-300 bg-gray-50 p-7 hover:border-brand-500 lg:p-10 dark:border-gray-700 dark:bg-gray-900 dark:hover:border-brand-500">
