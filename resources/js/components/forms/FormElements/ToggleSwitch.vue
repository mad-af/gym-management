                        ...
                        <div
                            :class="
                                switcherToggle1
                                    ...
                                    : 'translate-x-0'
                            "
                            class="absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-white shadow-theme-sm duration-300 ease-linear"
                        ></div>
                    </div>
                    Default
                </label>
                        ...
                        <div
                            :class="
                                switcherToggle3
                                    ...
                                    : 'translate-x-0'
                            "
                            class="absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-gray-50 shadow-theme-sm duration-300 ease-linear"
                        ></div>
                    </div>
                    Disabled
                </label>
