                    ...
                    <tr class="border-b border-gray-100 dark:border-gray-800">
                        ...
                        <th class="px-5 py-3">
                            <div class="col-span-2 flex items-center">
                                <p
                                    class="w-full text-right text-sm font-medium text-gray-700 dark:text-gray-400"
                                >
                                    Total
                                </p>
                            </div>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    <tr v-for="item in tableItems" :key="item.id">
                        ...
                        <td class="px-5 py-3.5">
                            ...
                            >
                                <p
                                    class="text-center text-theme-sm text-gray-500 dark:text-gray-400"
                                >
                                    {{ item.quantity }}
                                </p>
                            </div>
...
const tableItems = ref<TableItem[]>([
    { id: 1, product: 'TailGrids', quantity: 1, unitCost: '$48', total: '$48' },
    {
        id: 2,
        product: 'GrayGrids',
        quantity: 4,
    ...
    { id: 3, product: 'Uideck', quantity: 2, unitCost: '$800', total: '$1600' },
    {
        id: 4,
        product: 'FormBold',
        quantity: 2,
