<template>
    <div
        class="rounded-2xl border border-gray-200 bg-white xl:w-4/5 dark:border-gray-800 dark:bg-white/[0.03]"
    >
        <div
            class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-800"
        >
            <h3
                class="text-theme-xl font-medium text-gray-800 dark:text-white/90"
            >
                Invoice
            </h3>
        ...
        <div class="p-5 xl:p-8">
            ...
            <div
                class="my-6 border-b border-gray-100 pb-6 text-right dark:border-gray-800"
            >
