<template>
    <div
        ...
        <div class="mb-4 flex justify-between gap-2 sm:items-center">
            <div>
...
const campaigns = ref([
    ...
    },
    {
        creator: {
            name: 'Jocelyn Kenter',
            imageUrl: '/images/user/user-04.jpg',
        },
    ...
    },
    {
        creator: {
            ...
            imageUrl: '/images/user/user-05.jpg',
        },
        brand: { name: 'Brand 2', logo: '/images/brand/brand-02.svg' },
        title: 'Self branding',
        type: 'Ads campaign',
    ...
    },
    {
        creator: {
            name: 'James Lipshutz',
            imageUrl: '/images/user/user-06.jpg',
        },
        brand: { name: 'Brand 3', logo: '/images/brand/brand-03.svg' },
        title: 'Increase your website tra...',
        type: 'Ads campaign',
