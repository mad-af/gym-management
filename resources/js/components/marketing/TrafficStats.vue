<template>
    <div
        class="rounded-2xl border border-gray-200 bg-white px-5 pt-5 pb-1 sm:px-6 sm:pt-6 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex items-center gap-0.5 rounded-lg bg-gray-100 p-0.5 dark:bg-gray-900">
            <button v-for="option in options" :key="option" @click="selected = option" :class="[
                selected === option
        ...
        <div>
            ...
            <div class="flex items-end justify-between py-5">
                ...
                <div class="w-full max-w-[150px]">
                    <VueApexCharts type="area" height="70" :options="chartNineOptions" :series="chartNineData">
                    </VueApexCharts>
                </div>
            </div>

            <!-- Stats item -->
            <div class="flex items-end justify-between border-y border-gray-100 py-5 dark:border-gray-800">
                <div>
                    <p class="mb-1 text-sm text-gray-500 dark:text-gray-400">
                        Conversion Rate
                    </p>
                ...
                <div class="w-full max-w-[150px]">
                    <VueApexCharts type="area" height="70" :options="chartTenOptions" :series="chartTenData">
                    </VueApexCharts>
                </div>
            </div>
